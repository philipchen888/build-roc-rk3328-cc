...
apt-get upgrade -y
apt-get install -y build-essential git wget v4l-utils linux-firmware grub-efi-arm64 e2fsprogs zstd initramfs-tools lightdm lxde libegl1 libgles2 libgbm1 libgl1-mesa-dri libglx-mesa0 mesa-vdpau-drivers
ldconfig

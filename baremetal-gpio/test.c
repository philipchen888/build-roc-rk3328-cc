...
void dmac_test( void )
{
    unsigned int sram2ddrcode[8] __attribute__((aligned(64))) = {0x000000bc, 0x02bcff09, 0x20000000, 0xc2f701bc, 0x7f2000bd, 0x02380804, 0x00000000};
    ...
    // DMAMOV SAR 0xff090000           (BC,00,00,00,09,ff)
    // DMAMOV DAR 0x20000000           (BC,02,00,00,00,20)
    // DMAMOV CCR SB16 SS64 DB16 DS64  (BC,01,F7,C2,BD,00)
    // DMALP lc0 128                   (20,7f)
    // DMALD                           (04)
    // DMAST                           (08)
    // DMALPEND lc0                    (38,02)
